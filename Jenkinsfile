            ...
            stages {
                ...
                stage('Install Test Dependencies') {
                    ...
                    steps {
                        script {
                            ...
                            env.FAILURE_STAGE = 'Install Test Dependencies'
                            env.FAILURE_REASON = '품질 검증 준비 단계에서 실패했습니다. 테스트 의존성 설치를 확인해주세요.'
                        }
                        sh '''
                            node --version
                            corepack --version
                ...
                stage('Docker Build & Push Backend') {
                    ...
                    steps {
                        script {
                            env.FAILURE_CATEGORY = 'build'
                            env.FAILURE_STAGE = 'Docker Build & Push Backend'
                ...
                stage('Docker Build & Push Frontend') {
                    ...
                    steps {
                        script {
                            env.FAILURE_CATEGORY = 'build'
                            env.FAILURE_STAGE = 'Docker Build & Push Frontend'
